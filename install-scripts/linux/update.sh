...
return $__AS
    ...
    if [ $(echo $(echo ${choice} '==' 0 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') '||' $(echo ${choice} '>' "${#__5_architectures[@]}" | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//') != 0 ]; then
        ...
        __AF_echo_color144_v0__50_9="$__AF_echo_color144_v0";
        echo "$__AF_echo_color144_v0__50_9" > /dev/null 2>&1
        __AF_setup146_v0='';
        return 1
fi
    local architecture="${__5_architectures[$(echo ${choice} '-' 1 | bc -l | sed '/\./ s/\.\{0,1\}0\{1,\}$//')]}"
    echo_color__144_v0 "${architecture} selected" "${__3_BLUE}";
    __AF_echo_color144_v0__56_5="$__AF_echo_color144_v0";
    echo "$__AF_echo_color144_v0__56_5" > /dev/null 2>&1
    # Downloads the selected binary
    download_rlsd__145_v0 "rlsd-${architecture}";
    __AF_download_rlsd145_v0__59_8="$__AF_download_rlsd145_v0";
    if [ "$__AF_download_rlsd145_v0__59_8" != 0 ]; then
        echo_color__144_v0 "Install Succeeded" "${__2_GREEN}";
        __AF_echo_color144_v0__59_46="$__AF_echo_color144_v0";
        echo "$__AF_echo_color144_v0__59_46" > /dev/null 2>&1
else
        echo_color__144_v0 "Install Failed, check the above error message" "${__1_RED}";
        __AF_echo_color144_v0__60_11="$__AF_echo_color144_v0";
        echo "$__AF_echo_color144_v0__60_11" > /dev/null 2>&1
        __AF_setup146_v0='';
        return 1
fi
    __AF_setup146_v0=1;
...
declare -r args=("$0" "$@")
    ...
    if [ "$__AF_is_root98_v0__67_8" != 0 ]; then
        ...
        __AF_echo_color144_v0__68_9="$__AF_echo_color144_v0";
        echo "$__AF_echo_color144_v0__68_9" > /dev/null 2>&1
        setup__146_v0 ;
        __AS=$?;
        __AF_setup146_v0__70_28="$__AF_setup146_v0";
        result="$__AF_setup146_v0__70_28"
        if [ ${result} != 0 ]; then
            echo_color__144_v0 "Setup Finished" "${__2_GREEN}";
            __AF_echo_color144_v0__72_20="$__AF_echo_color144_v0";
            echo "$__AF_echo_color144_v0__72_20" > /dev/null 2>&1
else
            echo_color__144_v0 "Setup Failed" "${__1_RED}";
            __AF_echo_color144_v0__73_15="$__AF_echo_color144_v0";
            echo "$__AF_echo_color144_v0__73_15" > /dev/null 2>&1
fi
else
